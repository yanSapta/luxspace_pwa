...
registerRoute(
  ...
  ({ url }) => url.origin === self.location.origin && /\.(jpe?g|png|ico|svg)$/i.test(url.pathname), //url.pathname.endsWith('.png'), // Customize this strategy as needed, e.g., by changing to CacheFirst.
